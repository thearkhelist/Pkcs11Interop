...
{
    [TestClass]
    public class CKM_GOSTR3410_WITH_GOSTR3411_Tests
    {
        [TestMethod]
        public void _01_SignAndVerifySinglePartTest()
        {
            using (Pkcs11 pkcs11 = new Pkcs11(Settings.Pkcs11LibraryPath, Settings.UseOsLocking))
            {
                ...
                using (Session session = slot.OpenSession(false))
                {
                    ...
                    Mechanism mechanism = new Mechanism(CKM.CKM_GOSTR3411);
                    ...
                    mechanism = new Mechanism(CKM.CKM_GOSTR3410_WITH_GOSTR3411);
