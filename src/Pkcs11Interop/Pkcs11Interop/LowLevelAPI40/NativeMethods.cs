...
namespace Net.Pkcs11Interop.LowLevelAPI40
{
    internal static class NativeMethods
    {
        ...
        [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
        internal static extern uint C_EX_InitToken(uint slotId, byte[] pin, uint pinLen, CK_RUTOKEN_INIT_PARAM initInfo_s);
        ...
        [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
        internal static extern uint C_EX_GetTokenName(uint session, ref byte[] tokenName, ref uint tokenNameLen);

        [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
        internal static extern uint C_EX_SetLicense(uint session, uint licenseNume, byte[] license, uint licenseLen);

        [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
        internal static extern uint C_EX_GetLicense(uint session, uint licenseNume, ref byte[] license, ref uint licenseLen);
